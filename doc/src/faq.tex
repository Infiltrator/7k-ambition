...
\chapter[FAQ]{{\Huge FAQ}}

\index{frequently asked questions}

{\large \textbf{\textsf{How can I slow down or speed up the game?}}}

Press the 1–9, 0, \textbackslash, and Space keys on your keyboard.  1–9 sets
those speeds, and 0 sets speed 10.  \textbackslash will set the speed to
unlimited.  Space toggles pausing.  Many of the overlays and menus will still
function with the game speed set to zero.
