...
\textit{\textswab{\huge{S}}even Kingdoms: Ambition} can be downloaded from the
...
\textswab{\huge{T}}o play \textit{Seven Kingdoms: Ambition}, have any recent
...
\textswab{\huge{T}}he following will not work and are not fully supported:
...
(Partially supported) non-US keyboard mapping and UTF-8 input
\end{changemargin}
...
\textswab{\huge{Y}}our entrance to the world of \textit{Seven Kingdoms:
  Ambition} begins with \textbf{Double-Clicking} on your Seven Kingdoms:
Ambition Icon.
...
When you \textbf{Click} on the Training Sword, you will be taken to a menu
listing all of \textit{Seven Kingdoms: Ambition} Training lessons.
...
\textswab{\huge{T}}he Encyclopedia includes images and informative descriptions
of units and buildings appearing in \textit{Seven Kingdoms:
  Ambition}.  \textbf{Click} on one of the titles in the top section.  When you
do, you will see listed in the bottom section a group of subjects that are under
that title.
...
\textswab{\huge{A}}t the end of every game of \textit{Seven Kingdoms: Ambition},
your score will be computed.  Your score will take into account the difficulty
level at which you were playing and the skill with which you played.
...
\textswab{\huge{W}}hile you are playing a game of \textit{Seven Kingdoms:
  Ambition}, you will be able to access various options by \textbf{Clicking} on
the \textbf{MENU Button} at the top right of your screen.  This will bring up
the options as seen below.
...
You may also choose to play any single piece of \textit{Seven Kingdoms:
  Ambition} music.
...
\textswab{\huge{W}}hen you decide to retire from a game of \textit{Seven
  Kingdoms: Ambition}, the game will end, and your score will be calculated.
...
The Map I.D. is automatically copied to your system clipboard when you open up
the in-game menu.  You may then paste it anywhere you like.
...
%
%\begin{tabular}{p{1in} p{3in}}
    \textbf{1–9}, \textbf{0} & Set the speed of the Game.  0 is for speed 10.
    Faster speeds are available with the key below.\\ \\

    \textbf{-} and \textbf{+} & Decrease/increase the speed of the Game.  The
    game speed will change by 1 for every press.  Holding Shift while pressing
    \textbf{-} or \textbf{+} will change the speed more slowly.\\ \\

    \textbf{\textbackslash} & Set the game speed to Unlimited.  The game will
    run as fast as your computer can process it.  Warning: this can be
    \textbf{very} fast.\\ \\

    \textbf{Spacebar} & Pause/unpause the Game.  Many overlays and menus will
    still be operational even while the game is paused.  Units can be given new
    orders, but they will only carry them out once the game is resumed.\\ \\
...
%\begin{tabular}{p{1in} p{3in}}
    ...
    \textbf{<} and \textbf{>} & Go to the previous/next building of the same
    type as the currently selected one.\\ \\

    \textbf{,} and \textbf{.} & Go to the previous/next object of the same type
    and of the same nationality as the currently selected one.\\ \\
%\end{tabular}    
%
%\begin{tabular}{p{1in} p{3in}}
