...
A \textbf{Dark Green} bar shows that the unit has a maximum of \textbf{between 1
  and 59 Hit-Points}.

A \textbf{Light Green} bar shows that the unit has a maximum of \textbf{between
  60 and 94 Hit-Points}.

A \textbf{Yellow} bar shows that the unit has a maximum of \textbf{between 95
  and 129 Hit-Points}.

A \textbf{Purple} bar shows that the unit has a maximum of \textbf{between 130
  and 164 Hit-Points}.

A \textbf{Red} bar shows that the unit has a maximum of \textbf{at least 165
  Hit-Points}.
...
\textswab{\huge{T}}o set waypoints for your People, Ships, or Weapons to follow,
first select the unit(s).  Then, holding down the \textbf{Shift} or \textbf{Alt}
keys, \textbf{Right-Click} on either the world map or your main screen.  For
each \textbf{Right-Click}, you will set a waypoint.  Your selected units will
begin to move as soon as the first waypoint has been set.

You may delete a waypoint (apart from the first) by \textbf{Right-Clicking}
while holding \textbf{Shift} or \textbf{Alt} on the waypoint marker while the
unit is selected.
