...
\usepackage{fancyhdr} % An extended support for fancy headers and footers
    ...
    \fancyhf[roh]{\textit{Seven Kingdoms: Ambition}}
...
{\Huge{\textbf{Ambition}}}~\\[1cm]
{\huge{\textbf{Instruction Manual}}}
}
\author{Chris Whitehouse et al. \\
  Updated by members of \\
  the Seven Kingdoms: Ancient Adversaries \\
  and Seven Kingdoms: Ambition OSS Projects}
\date{2026-08-31}
...
Seven Kingdoms: Ambition Instruction Manual
...
The music is the work of Bjørn Lynne, Copyright 1997, and is not provided under
the GPL.  It may be freely downloaded and used with \textit{Seven Kingdoms:
  Ambition} but not modified or repurposed into derivative works.
...
The official website for \textit{Seven Kingdoms: Ambition} OSS Project is at
\url{https://sourceforge.net/projects/seven-kingdoms-ambition/}.  Here, you will
find the fora and download pages.

\textit{Seven Kingdoms: Ambition} is a fork of 7kfans' \textit{Seven Kingdoms:
  Ancient Adversaries}, which has been under active development since its
release in 2009.  If you want to see what has been fixed or changed, see the
changelogs for the official releases under News.

This manual is part of the community project. It has been updated to reflect the
current status of \textit{Seven Kingdoms: Ambition}.
