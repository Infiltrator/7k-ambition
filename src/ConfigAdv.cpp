...
static const char *keyevent_map[] = {
	...
	"KEYEVENT_SPY_ASSASSINATE",
	"KEYEVENT_SPY_BRIBE",
	"KEYEVENT_SPY_CAPTURE",
	"KEYEVENT_SPY_CHANGE_MISSION",
	"KEYEVENT_SPY_MOBILISE",
	"KEYEVENT_SPY_MENU",
	"KEYEVENT_SPY_STEAL_REPORTS",

	"KEYEVENT_TRAIN_BUILDER",
	"KEYEVENT_TRAIN_SOLDIER",
	"KEYEVENT_TRAIN_MINER",
	"KEYEVENT_TRAIN_ARTISAN",
	"KEYEVENT_TRAIN_RESEARCHER",
	"KEYEVENT_TRAIN_SPY",
