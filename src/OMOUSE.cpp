 ...
 * Copyright 2025â€“26 Tim Sviridov
 *
...
void Mouse::init_key()
{
	...
	bind_key(KEYEVENT_OBJECT_PREV, "shift+,");
	bind_key(KEYEVENT_OBJECT_NEXT, "shift+.");
	bind_key(KEYEVENT_NATION_OBJECT_PREV, ",");
	bind_key(KEYEVENT_NATION_OBJECT_NEXT, ".");
