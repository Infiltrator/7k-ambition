    ...
    .sections = {
      {
        ...
        .items = {
          ...
          _("Added Technology report scrolling with the mouse wheel or touchpad, up/down keys, pg up/pg down keys, left/right keys, and home/end keys."),
          _("Added Ranking report scrolling with the mouse wheel or touchpad, up/down keys, pg up/pg down keys, left/right keys, and home/end keys."),
