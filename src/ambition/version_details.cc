    ...
    .sections = {
      {
        ...
        .items = {
          ...
          _("Added news scrolling with the mouse wheel or touchpad (when the cursor is inside the viewport), up/down keys, pg up/pg down keys, left/right keys, and home/end keys."),
