...
std::vector<VersionUpdates> getVersionDetails(
  ...
  {
    .identifier = _("v3.2.13 — 2026-09-13"),
    .sections = {
      {
      ...
      },
      {
        ...
        .items = {
          ...
          _("Fixed the corruption of the auto-tax and auto-grant help text in the Russian translation."),
      ...
      },
      {
        ...
        .items = {
          ...
          _("Draw building link icons at a constant FPS, independent of game speed."),
  ...
  {
    .identifier = _("v3.2.12 — 2026-09-01"),
    .sections = {
      {
        .heading = HEADING_ADDED,
        .items = {
  ...
  {
    .identifier = _("v3.2.11 — 2026-08-24"),
    .sections = {
      {
        .heading = HEADING_ADDED,
        .items = {
          _("Added a locale selection screen, for switching locales (languages)."),
          _("Added a Latin translation, thanks to Júlia Rosell Saldaña."),
  ...
  {
    .identifier = _("v3.2.10 -- 2026-06-12"),
    .sections = {
      {
        .heading = HEADING_FIXED,
        .items = {
          _("Fixed the display of non-standard characters on Windows (especially Júlia Rosell Saldaña's name on the What's New screen)."),
  ...
  {
    .identifier = _("v3.2.9 -- 2026-06-05"),
    .sections = {
      {
        .heading = HEADING_ADDED,
        .items = {
    ...
    .sections = {
      ...
      },
      {
        ...
        .items = {
          ...
          _("Fixed the Encyclopaedia slideshow showing a blank image until the mouse was moved."),
          _("Fixed the grammar in the \"Desperate Bowmen\" scenario description."),
      ...
      },
      {
        ...
        .items = {
          ...
          _("Music now plays on the encyclopaedia."),
          _("More changes to make development easier."),
        },
      },
    },
  },
    ...
    .sections = {
      ...
      },
      {
        ...
        .items = {
          ...
          _("Pause replays at the end instead of immediately exiting to the menu without warning."),
        },
      },
    },
  },
