...
std::vector<VersionUpdates> versionDetails = {
  ...
  },
  {
    ...
    .sections = {
      {
        .heading = _("Changes taken from Ambition"),
        .items = {
      ...
      },
      {
        ...
        .items = {
          ...
          _("Tried again to fix mouse sticky/scrolling issues"),
          _("Fixed some game file bugs"),
          _("Fixed a problem with unit pathing to board ships"),
          ...
          _("Fixed ai to check skill of workers in managements actions"),
          _("Fixed ai to prioritize higher skilled generals in management actions"),
          _("Fixed ai to prioritize higher combat level soldiers in management actions"),
      ...
      },
      {
        ...
        .items = {
          ...
          _("Improved caravan/caraval trade stop code"),
          ...
          _("Increased the max file limit of screenshots"),
          _("Improved manual, added cover"),
