...
#define APP_NAME "SK:A" // application name (?)
#define WIN_CLASS_NAME "Seven_Kingdoms_Ambition" // for registering window class
#define WIN_TITLE "Seven Kingdoms: Ambition" // Window title.
...
// config dir
#define CONFIG_ORGANIZATION_NAME "7k-ambition"
#define CONFIG_APPLICATION_NAME "7k-ambition"
